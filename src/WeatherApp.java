...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        try{
            ...
            int index = findIndexOfCurrentTim(time);
    ...
    private static int findIndexOfCurrentTim(JSONArray timeList) {
        String currentTime = getCurrentTime();

        // iterate through the time list and see which one matches our current time
        for (int ind = 0; ind < timeList.size(); ind++){
            String time = (String) timeList.get(ind);
    ...
    public static JSONArray getLocationData(String locationName) {
        ...
        String urlString = "https://geocoding-api.open-meteo.com/v1/search?name=" +
                locationName + "&count=2&language=en&format=json";
        ...
        try{
            ...
            if(conn.getResponseCode() != 200){
                ...
                // get the list of location data the API generated from the lcoation name
    ...
    private static HttpURLConnection fetchApiResponse(String urlString) throws MalformedURLException {
        try{
